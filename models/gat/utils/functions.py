...
def load_problem(name):
    from models.gat.problems import TSP
    problem = {
        'tsp': TSP,
    }.get(name, None)
...
def load_model(path, epoch=None):
    from models.gat.nets.attention_model import AttentionModel
    from models.gat.nets.pointer_network import PointerNetwork
